...
var file_product_info_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x65, 0x63,
	0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x22, 0x4f, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75,
	...
	,
}
...
var file_product_info_proto_goTypes = []interface{}{
	(*Product)(nil),   // 0: service.ecommerce.Product
	(*ProductID)(nil), // 1: service.ecommerce.ProductID
}
var file_product_info_proto_depIdxs = []int32{
	0, // 0: service.ecommerce.ProductInfo.addProduct:input_type -> service.ecommerce.Product
	1, // 1: service.ecommerce.ProductInfo.getProduct:input_type -> service.ecommerce.ProductID
	1, // 2: service.ecommerce.ProductInfo.addProduct:output_type -> service.ecommerce.ProductID
	0, // 3: service.ecommerce.ProductInfo.getProduct:output_type -> service.ecommerce.Product
...
func (c *productInfoClient) AddProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ProductID, error) {
	out := new(ProductID)
	err := c.cc.Invoke(ctx, "/service.ecommerce.ProductInfo/addProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productInfoClient) GetProduct(ctx context.Context, in *ProductID, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, "/service.ecommerce.ProductInfo/getProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductInfo_AddProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.ecommerce.ProductInfo/AddProduct",
	}
...
func _ProductInfo_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.ecommerce.ProductInfo/GetProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ProductInfo_serviceDesc = grpc.ServiceDesc{
	ServiceName: "service.ecommerce.ProductInfo",
